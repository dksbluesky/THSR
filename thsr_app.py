...
def get_data():
    # 南下資料 (南港 -> 台南) 
    southbound_raw = [
        ["583", "每日", "06:15", "06:26", "06:34", "06:45", "07:02", "07:13", "07:32", "07:45", "07:56", "08:10", "08:28", "08:40"],
        ["203", "每日", "-", "06:30", "06:38", "-", "-", "-", "07:20", "-", "-", "07:45", "08:03", "08:15"],
        ["1103", "2/14-2/19, 2/23", "06:35", "06:46", "06:54", "-", "-", "-", "07:35", "-", "-", "-", "-", "08:20"],
        ["603", "每日", "06:40", "06:51", "07:00", "07:15", "07:27", "07:47", "07:58", "08:17", "08:30", "08:41", "08:55", "09:25"],
        ...
        ["207", "每日", "-", "08:20", "08:39", "-", "-", "-", "09:12", "-", "-", "09:42", "09:58", "10:10"],
        ["615", "每日", "08:35", "08:46", "08:55", "09:10", "09:22", "-", "09:40", "-", "-", "10:14", "10:33", "10:45"],
        ...
        ["1213", "每日", "09:40", "09:51", "09:59", "-", "-", "-", "10:40", "-", "-", "-", "11:18", "11:30"],
        ...
        ["125", "每日", "11:10", "11:21", "11:29", "-", "-", "-", "12:20", "-", "-", "-", "-", "13:05"],
        ["633", "每日", "11:10", "11:21", "11:29", "11:43", "11:56", "-", "12:25", "-", "-", "12:50", "13:14", "-"],
        ...
        ["1225", "每日", "12:40", "12:51", "12:59", "-", "-", "-", "13:40", "-", "-", "-", "14:18", "14:30"],
        ...
        ["1241", "每日", "16:40", "16:51", "16:59", "-", "-", "-", "17:40", "-", "-", "-", "18:18", "18:30"],
        ...
        ["567", "每日", "22:35", "22:50", "23:08", "23:21", "23:32", "23:43", "23:59", "-", "-", "-", "-", "-"]
    ]
    cols_south = ["車次", "行駛日", "南港", "台北", "板橋", "桃園", "新竹", "苗栗", "台中", "彰化", "雲林", "嘉義", "台南", "左營"]

    # 北上資料 (台南 -> 南港) 
    northbound_raw = [
        ["502", "每日", "05:45", "05:57", "06:15", "06:29", "06:40", "06:52", "07:14", "07:27", "07:39", "07:50", "08:01", "08:10"],
        ...
        ["300", "每日", "05:50", "06:03", "06:21", "-", "-", "06:44", "-", "-", "07:29", "07:47", "07:55", "-"],
        ["1510", "2/13-2/14, 2/17-2/23", "06:25", "06:38", "06:57", "07:12", "07:25", "07:36", "07:58", "08:10", "08:24", "08:38", "08:47", "08:55"],
        ["802", "每日", "06:15", "06:29", "06:48", "07:00", "07:13", "07:25", "07:45", "07:58", "08:12", "08:27", "08:40", "08:50"],
        ["1302", "2/13, 2/19-2/23", "06:45", "06:59", "07:19", "07:32", "07:42", "07:53", "-", "-", "-", "-", "08:47", "08:55"],
        ["204", "每日", "06:55", "07:07", "-", "-", "-", "07:40", "-", "-", "-", "08:27", "08:37", "08:45"],
        ...
        ["622", "每日", "09:35", "09:48", "10:06", "-", "-", "10:32", "-", "10:57", "11:11", "11:25", "11:36", "11:45"],
        ...
        ["1634", "每日", "11:35", "11:48", "12:08", "-", "-", "12:32", "-", "12:57", "13:11", "13:25", "13:36", "13:45"],
        ...
        ["1234", "每日", "14:15", "14:28", "14:45", "-", "-", "15:17", "-", "-", "-", "16:02", "16:13", "16:25"],
        ...
        ["600", "每日", "21:05", "21:18", "21:37", "-", "-", "22:05", "-", "22:30", "22:43", "22:56", "23:07", "23:15"],
...
def main():
    ...
    st.markdown("快速篩選 **台南 ↔ 南港** 行車時間小於 120 分鐘的班次")
    ...
    # 1. 選擇方向
    direction = st.sidebar.radio("方向選擇", ["南下 (南港 → 台南)", "北上 (台南 → 南港)"])
    ...
    if results:
        ...
        st.subheader(f"查詢結果：{selected_date} ({direction})")
        st.write(f"共找到 **{len(result_df)}** 班符合條件的直達/快車（行車 ≤ 120 分），已按發車順序排列：")
        
        # 顯示表格 (針對 '行車時間 (分)' 進行顏色漸層 highlight，時間越短越顯眼)
        st.dataframe(
            ...
            column_config={
                ...
                "行車時間 (分)": st.column_config.NumberColumn("行車時間 (分)", format="%d 分鐘"),
            }
        )
    else:
        st.warning("⚠️ 在此時段內找不到符合條件的班次（可能該時段皆為站站停列車，行車時間超過 120 分鐘）。")
